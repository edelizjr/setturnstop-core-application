...
To build the final jar and optimize the setturnstop application for production, run:
...
[doing api-first development]: https://www.jhipster.tech/documentation-archive/v7.9.0/doing-api-first-development/
